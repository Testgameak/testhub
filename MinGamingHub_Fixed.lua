...
function Update:Window(text,logo,keybind)
  ...
  --  UserImage.BackgroundColor3 = Color3.fromRGB(225, 225, 225)
    ...
    Tab.Size = UDim2.new(0, 140, 0, 210)
    ...
    function main:AddSlider(text, min, max, start, callback)
        ...
        -- Prop --
        SliderFrame.Name = text or "SliderFrame"
            ...
            if _G.AutoEctoplasm and World2 then
                pcall(function()
                    if game:GetService("Workspace").Enemies:FindFirstChild("Ship Deckhand") or game:GetService("Workspace").Enemies:FindFirstChild("Ship Engineer") or game:GetService("Workspace").Enemies:FindFirstChild("Ship Steward") or game:GetService("Workspace").Enemies:FindFirstChild("Ship Officer") then
                        for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                            if v.Name == "Ship Officer" or v.Name == "Ship Steward" or v.Name == "Ship Engineer" or v.Name == "Ship Deckhand" then
                                if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                    repeat task.wait()
                                        AutoHaki()
                                        EquipWeapon(_G.SelectWeapon)
...
spawn(function()
    ...
    M:AddToggle("Farm Magma Ore",_G.Umm,function(value)
_G.Umm = value
StopTween(_G.Umm)
end)
...
spawn(function()
    ...
    M:AddToggle("Farm Angel Wings",_G.Auto_Wing,function(value)
_G.Auto_Wing = value
...
spawn(function()
    ...
    M:AddToggle("Farm Leather",_G.Leather,function(value)
_G.Leather = value
...
spawn(function()
    ...
    M:AddToggle("Hop Farm",_G.StardHop,function(value)
    _G.StardHop = value
    end)
...
M:AddToggle("Auto Kill Terrorshark",_G.bjirTerrorshark,function(value)
...
M:AddToggle("Auto Kill Shark",_G.bjirShark,function(value)
_G.bjirShark = value
...
spawn(function()
    ...
    M:AddToggle("Auto Kill Piranha",_G.bjirPiranha,function(value)
...
HyperCahaya(CFrame.new(-5419.98095703125, 1093.3375244140625, -2666.730712890625))
    ...
    M:AddToggle("Kill Greybeard", _G.Autogay,function(value)
         _G.Autogay = value
        StopTween( _G.Autogay)
    end)
    
    M:AddToggle("Kill Greybeard Hop", _G.Autogayhop,function(value)
         _G.Autogayhop = value
    end)
    ...
    M:AddToggle("Taken Pole v1", _G.Autopole,function(value)
         _G.Autopole = value
        StopTween( _G.Autopole)
    end)
    
    M:AddToggle("Taken Pole v1 Hop", _G.Autopolehop,function(value)
    ...
    M:AddToggle("Taken Sharks saw", _G.Autosaw,function(value)
         _G.Autosaw = value
        StopTween( _G.Autosaw)
    end)
    
    M:AddToggle("Taken Shark Saw Hop", _G.Autosawhop,function(value)
         _G.Autosawhop = value
    end)
 ...
 spawn(function()
	...
	spawn(function()
		pcall(function()
			game:GetService("RunService").Heartbeat:Connect(function()
				game:GetService("RunService").Heartbeat:Wait()
			if _G.AutoObservationHakiV2 and StartMagnet then
					for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
                ...
                pcall(function()
                    for i,v in pairs(game:GetService("Players").LocalPlayer.Backpack:GetChildren()) do
                        if string.find(v.Name, "Fruit") then
                            ...
                            EquipWeapon(v.Name)
                            game:GetService("Players").LocalPlayer.Character:FindFirstChild(_G.SelectFruitEat).EatRemote:InvokeServer("Drop")
                        end
                    end
